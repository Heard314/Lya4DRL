"""1 server, 10 devices — device_dly_adj_fac=0.8, edge_dly_adj_fac=1.0"""
import sys, os
...
sys.argv = [
    "main",
    "--train_mode", "maddpg",
    "--run_desc", "single_1s10d_thre_dev0_8_edge1_0",
...
gen_params.device_dly_adj_fac = [0.8, 0.8, 0.8]
gen_params.edge_dly_adj_fac = [1.0, 1.0, 1.0]

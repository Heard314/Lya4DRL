"""1 server, 10 devices — device_dly_adj_fac=0.2, edge_dly_adj_fac=0.6"""
import sys, os
...
sys.argv = [
    "main",
    "--train_mode", "maddpg",
    "--run_desc", "single_1s10d_thre_dev0_2_edge0_6",
...
gen_params.device_dly_adj_fac = [0.2, 0.2, 0.2]
gen_params.edge_dly_adj_fac = [0.6, 0.6, 0.6]

python ../../../main.py --train_mode maddpg --run_desc "no_queue_exp8" \
    ...
    --device_act_queue_growth_rate 1 --device_vir_queue_growth_rate 0.05 \
    --edge_act_queue_growth_rate 1 --edge_vir_queue_growth_rate 0.05 \

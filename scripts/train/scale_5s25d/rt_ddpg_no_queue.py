"""5 servers, 25 devices — RT-MADDPG baseline (actual queue reward only)"""
import sys, os
...
sys.argv = [
    "main",
    "--train_mode", "maddpg",
    "--run_desc", "scale_5s25d_rt_ddpg_no_queue",
    ...
    "--action_dim", "8",
    "--value_input_obs_dim", "500",
    "--value_input_act_dim", "200",
    "--value_input_dims", "700",
    "--policy_input_dim", "20",
]

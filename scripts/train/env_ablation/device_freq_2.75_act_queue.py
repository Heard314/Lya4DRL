"""Device computation frequency ablation: 2.75 Gcycles/s (actual queue reward only)"""
import sys, os
...
sys.argv = [
    "main",
    "--train_mode", "maddpg",
    "--run_desc", "dev_freq_2.75_act_queue",
...
gen_params.device_comp_freqs = [2.75, 2.75, 2.75]
